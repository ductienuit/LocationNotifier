package com.trafficanalysics.search;
...
public class ResultListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ResultListAdapter listAdapter = new ResultListAdapter(this,
                android.R.layout.simple_list_item_1, MapViewFragment.s_ResultList);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        DiscoveryResult result = MapViewFragment.s_ResultList.get(position);
